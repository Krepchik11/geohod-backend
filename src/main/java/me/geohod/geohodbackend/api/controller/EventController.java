...
public class EventController {
    ...
    @GetMapping
    public ResponseEntity<Page<EventDetailsResponse>> getAllEvents(@RequestParam(required = false, defaultValue = "false") boolean iamAuthor,
                                                                   @RequestParam(required = false, defaultValue = "false") boolean iamParticipant,
    ...
    public ResponseEntity<EventCreateResponse> createEvent(@RequestBody EventCreateRequest request,
        ...
        CreateEventDto createDto = mapper.map(request, userId);
