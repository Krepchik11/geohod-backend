...
enum NotificationType {
    EVENT_CANCELLED {
        @Override
        public String formatMessage(EventNotificationService.EventContext context, NotificationParams params) {
    ...
    public abstract String formatMessage(EventNotificationService.EventContext context, NotificationParams params); // Abstract formatMessage
