...
STAGING_DIR="${HOME}/geohod-backend-dev/v2"
SERVICE_NAME="geohod-stack-dev-v2"
IMAGE_TARBALL="${STAGING_DIR}/geohod-backend-image.tar.gz"
SERVICE_DIR="${HOME}/.config/systemd/user"

echo "--- Starting Geohod Backend v2 Deployment ---"
...
echo "--- Geohod Backend v2 deployment finished ---"