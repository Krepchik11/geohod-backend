...
Install [Caddy](https://caddyserver.com/docs/install) and configure `/etc/caddy/Caddyfile` to proxy `yourdomain.com → 127.0.0.1:8080`. Caddy handles TLS automatically.
